...
**Дата:** 2026-05-01  
**Обновлено:** 2026-05-01 — Анализ завершён, качество поддерживается  
...
1. **API тестирование** — добавить unit тесты для API routes (0 тестов сейчас)
2. **E2E тесты auth** — исправить 2 todo теста (redirect protection)
...
5. **Lighthouse замеры** — выполнить production замеры (цель: > 90)
6. **Storybook документация** — добавить stories для missing компонентов
